...
class AccuweatherHelper {
  static Future<Accuweatherweather> getTodaysAccuweather(
    ...
    final accuweatherdart = AccuweatherweatherWithDart.fromJson(accuweatherdecodedResponse);

    
    print('accuweatherwith dart headline date = ${accuweatherdart.headline.effectiveDate}');
    print('accuweatherwith dart headline severity = ${accuweatherdart.headline.severity.toString()}');
    
    print('accuweatherwith dart headline text = ${accuweatherdart.headline.text}');
    print('accuweatherwith dart headline category = ${accuweatherdart.headline.category}');
    print('accuweatherwith dart headline enddate = ${accuweatherdart.headline.endDate}');

    print('accuweatherwith dart fcast date = ${accuweatherdart.dailyForecasts[0].date}'); 
    print('accuweatherwith dart fcast min temp = ${accuweatherdart.dailyForecasts[0].temperature.minimum.value.toString()}'); 
    print('accuweatherwith dart fcast max temp = ${accuweatherdart.dailyForecasts[0].temperature.maximum.value.toString()}');

    print('accuweatherwith dart day icon = ${accuweatherdart.dailyForecasts[0].day.icon.toString()}');
    print('accuweatherwith dart day phrase = ${accuweatherdart.dailyForecasts[0].day.iconPhrase}');
    print('accuweatherwith dart day has precip = ${accuweatherdart.dailyForecasts[0].day.hasPrecipitation.toString()}');
    print('accuweatherwith dart day precip type= ${accuweatherdart.dailyForecasts[0].day.precipitationType}');
    print('accuweatherwith dart day precip intensity= ${accuweatherdart.dailyForecasts[0].day.precipitationIntensity}');

    print('accuweatherwith dart night icon = ${accuweatherdart.dailyForecasts[0].night.icon.toString()}');
    print('accuweatherwith dart night phrase = ${accuweatherdart.dailyForecasts[0].night.iconPhrase}');
    print('accuweatherwith dart night has precip = ${accuweatherdart.dailyForecasts[0].night.hasPrecipitation.toString()}');
    print('accuweatherwith dart night precip type= ${accuweatherdart.dailyForecasts[0].night.precipitationType}');
    print('accuweatherwith dart night precip intensity= ${accuweatherdart.dailyForecasts[0].night.precipitationIntensity}');
